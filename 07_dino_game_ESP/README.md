...
## Β. Περιγραφή
Πρόκειται για έναν απλοποιημένο κλώνο του δημοφιλούς παιχνιδιού με τον **Dino** της Google που εμφανίζεται στον Chrome όταν δεν έχουμε internet, χρησιμοποιούμε ESP και έγχρωμη οθόνη TFT 1.8".
...
## 🚀 Οδηγίες Χρήσης
1. Πραγματοποιήστε την super έυκολη συνδεσμολογια 
2. ...
3. ...
4. ...
