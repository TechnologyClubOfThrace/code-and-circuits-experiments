...
### 2. Διαχείριση Ήχου
Οι προηχογραφημένες απαντήσεις πρέπει να αποθηκευτούν σαν MP3s στην κάρτα SD με συγκεκριμένη ονοματολογία για να είναι προσβάσιμα από το DFPlayer:
* `001.mp3`, `002.mp3` ... `xxx.mp3`
* Στην αρχική version idle αρχεία, έχουν θέσεις 30 με 45, ενώ οι υπόλοιπες απαντήσεις ξεκινούν από την θέση 1
* Προσοχή οι απαντήσεις είναι περισσότερες από τις ερωτήσεις καθώς σε κάποιες απαντήσεις προστέθηκε τυχαιότητα, έτσι όταν το robot καλέιτε να πει ενα αστείο λέει ένα απο τα 6 που υπάρχουν συνολικά δλδ με ένα command 6 απαντήσεις, σε άλλη περίπτωση υπάρχουν 2 απαντήσεις η μια επαναλαμβάνετε με ποσοστό 80% και η άλλη με 20%.
