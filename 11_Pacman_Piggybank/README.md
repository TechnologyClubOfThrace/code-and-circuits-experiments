...
> Σιγουρευτείτε ότι το servo καλύπτει όλο το εύρος κίνησης και ότι δεν έχετε το servo ανάποδα. Κρατήστε πρώτα με το χέρι. Τοποθετησετε τον μηχανισμό στήριξης, δοκιμάστε ξανά. Σημειώστε το σημείο που βολέυει να βρίσκετε ο μηχανισμός στήριξης και το servo. Ο μηχανισμός στήριξης επίσης έχει 2 τρύπες για να στερεωθεί με tireup.
